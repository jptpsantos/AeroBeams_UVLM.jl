# Entry-level postprocessing extension: aerodynamic solver fingerprints remain
# unchanged. The estimator has its own fingerprint in study.toml/damping_fit.toml.
